...
class SearchWebsite:
    ...
    def __init__(self, customer_distribution, p_click, p_sale, n_companies=5, recording=False):
        """Initialization function
        ...
        self.prob_click = p_click
        self.prob_sale = p_sale
        self.recording = recording

    def set_prob_click(self, p_click):
        self.prob_click = p_click

    def set_prob_sale(self, p_sale):
        self.prob_sale = p_sale
